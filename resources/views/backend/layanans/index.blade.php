            ...
            <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        @forelse($layanans as $layanan)
                            <tr class="text-gray-700 dark:text-gray-400">
                                <td class="px-4 py-3 text-2xl">
                                    <i class="{{ $layanan->icon_class }} text-blue-600"></i>
                                </td>
                                <td class="px-4 py-3">
                                    <p class="font-semibold">{{ $layanan->title }}</p>
                                    <p class="text-xs text-gray-500">{{ Str::limit($layanan->description, 50) }}</p>
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="px-4 py-3 text-center text-gray-500 dark:text-gray-400">Belum ada layanan
                                    terdaftar</td>
                            </tr>
                        @endforelse
                    </tbody>
