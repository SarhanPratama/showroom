<aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
  <div class="py-4 text-gray-500 dark:text-gray-200">
    ...
    <ul>
      ...
      <!-- Manajemen Konten -->
      <li class="relative px-2 py-1"
        x-data="{ isKontenMenuOpen: {{ request()->is('admin/slider*', 'admin/layanan*', 'admin/testimonial*', 'admin/setting*') ? 'true' : 'false' }} }">
        <button
          class="inline-flex items-center justify-between w-full px-4 py-2 text-sm font-semibold transition-colors duration-150 rounded-lg hover:bg-gray-100 hover:text-gray-800 dark:hover:bg-gray-800 dark:hover:text-gray-200 {{ request()->is('admin/slider*', 'admin/layanan*', 'admin/testimonial*', 'admin/setting*') ? 'text-gray-800 dark:text-gray-100 bg-gray-100 dark:bg-gray-800' : 'text-gray-800 dark:text-gray-200' }}"
          @click="isKontenMenuOpen = !isKontenMenuOpen" aria-haspopup="true">
          <span class="inline-flex items-center">
            <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
          ...
          <svg class="w-4 h-4 transition-transform duration-200" :class="{ 'rotate-180': isKontenMenuOpen }"
            aria-hidden="true" fill="currentColor" viewBox="0 0 20 20">
            <path fill-rule="evenodd"
              d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
              clip-rule="evenodd"></path>
        ...
        <template x-if="isKontenMenuOpen">
          <ul x-transition:enter="transition-all ease-in-out duration-300" x-transition:enter-start="opacity-25 max-h-0"
            x-transition:enter-end="opacity-100 max-h-xl" x-transition:leave="transition-all ease-in-out duration-300"
            x-transition:leave-start="opacity-100 max-h-xl" x-transition:leave-end="opacity-0 max-h-0"
            class="p-2 mt-2 space-y-2 overflow-hidden text-sm font-medium text-gray-500 bg-gray-50 dark:bg-gray-900 rounded-md shadow-inner dark:text-gray-200"
            ...
            <li
              class="px-2 py-1 transition-colors duration-150 rounded-md hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800">
              <a class="block w-full" href="{{ route('admin.slider.index') }}">Slider Depan</a>
            </li>
            <li
              class="px-2 py-1 transition-colors duration-150 rounded-md hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800">
              <a class="block w-full" href="{{ route('admin.layanan.index') }}">Daftar Layanan</a>
            </li>
            <li
              class="px-2 py-1 transition-colors duration-150 rounded-md hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800">
              <a class="block w-full" href="{{ route('admin.testimonial.index') }}">Testimonial</a>
            </li>
            <li
              class="px-2 py-1 transition-colors duration-150 rounded-md hover:text-gray-800 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-800">
              <a class="block w-full" href="{{ route('admin.setting.index') }}">Pengaturan Web</a>
            </li>
          </ul>
        </template>
      </li>
