...
<div class="container grid px-6 mx-auto animate-fade-in-up">
  ...
  <div class="flex items-center justify-between my-6">
      ...
      <div x-data="{ open: false }" @click.away="open = false" @keydown.escape="open = false" class="relative z-30">
          <button @click="open = !open" 
              ...
              <svg class="w-4 h-4 ml-2 transition-transform duration-200" :class="{ 'rotate-180': open }" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
          </button>
          ...
          <div x-show="open" 
              ...
              <form action="{{ route('admin.dashboard') }}" method="GET" class="p-4">
                  <div class="mb-4">
                      ...
                      <select name="month" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray rounded-md">
                  ...
                  <div class="mb-4">
                      ...
                      <select name="year" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray rounded-md">
                  ...
                  <div class="flex items-center justify-between pt-2 border-t dark:border-gray-700 mt-2">
                       <a href="{{ route('admin.dashboard') }}" class="text-sm font-medium text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Reset</a>
  ...
  <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
    <!-- Card 1 -->
    <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800 transform hover:scale-105 transition duration-300">
    ...
    <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800 transform hover:scale-105 transition duration-300">
      ...
      <div>
        <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Pesanan Baru ({{ $filterMonth ? date('M', mktime(0,0,0,$filterMonth,1)) : 'All' }})</p>
    ...
    <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800 transform hover:scale-105 transition duration-300">
      ...
      <div>
        <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Pendapatan ({{ $filterMonth ? date('M', mktime(0,0,0,$filterMonth,1)) : 'All' }})</p>
        <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">Rp {{ number_format($pendapatan, 0, ',', '.') }}</p>
      </div>
    </div>
    <!-- Card 4 -->
    <div class="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800 transform hover:scale-105 transition duration-300">
    ...
    <div class="w-full overflow-x-auto">
      <table class="w-full whitespace-no-wrap">
        ...
        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
          ...
          <tr class="text-gray-700 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors duration-150">
            <td class="px-4 py-3">
            ...
            <td class="px-4 py-3 text-xs">
                ...
                @elseif($pesanan->status_pesanan == 'diproses')
                    <span class="px-2 py-1 font-semibold leading-tight text-blue-700 bg-blue-100 rounded-full dark:text-white dark:bg-blue-600">Diproses</span>
                @else
                  <span class="px-2 py-1 font-semibold leading-tight text-red-700 bg-red-100 rounded-full dark:text-white dark:bg-red-600">Batal</span>
                @endif
            </td>
          ...
          @empty
          <tr><td colspan="5" class="px-4 py-3 text-center">Belum ada pesanan terbaru.</td></tr>
          @endforelse
        </tbody>
      </table>
    </div>
